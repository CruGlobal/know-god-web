...
import { Header } from 'src/app/services/xml-parser-service/xmp-parser.service';
...
export class PageHeaderNewComponent implements OnChanges {
  @Input() header: Header;
