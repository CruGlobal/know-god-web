...
import { PageHeaderNewComponent } from './page-header.component';

describe('pageHeaderComponent', () => {
  let component: PageHeaderNewComponent;
  let fixture: ComponentFixture<PageHeaderNewComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [PageHeaderNewComponent],
      providers: [{ provide: PageService, useValue: pageService }],
    }).compileComponents();
    fixture = TestBed.createComponent(PageHeaderNewComponent);
