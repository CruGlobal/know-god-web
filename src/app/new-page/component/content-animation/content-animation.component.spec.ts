...
import { ContentAnimationNewComponent } from './content-animation.component';

describe('ContentAnimationComponent', () => {
  let component: ContentAnimationNewComponent;
  let fixture: ComponentFixture<ContentAnimationNewComponent>;
